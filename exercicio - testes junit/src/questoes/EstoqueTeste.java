...
public class EstoqueTeste {
	...
	public void testeRepor() {
		Estoque estoque1 = new UsaEstoque("Impressora Jato de Tinta", 13, 6);
        Estoque estoque2 = new UsaEstoque("Monitor LCD 17 polegadas", 11, 13);
        Estoque estoque3 = new UsaEstoque("Mouse Ótico", 6, 2);
